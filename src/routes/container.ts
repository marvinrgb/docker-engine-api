...
router.get('/container/:id', async (req:Request, res:Response) => {
...
router.post('/container/start/:id', async (req:Request, res:Response) => {
...
router.post('/container/stop/:id', async (req:Request, res:Response) => {
